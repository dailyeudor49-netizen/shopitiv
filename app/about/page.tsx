...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Shopitiv, your trusted wholesale tech partner.",
};
    ...
    <div className="bg-white">
      <section className="bg-gradient-to-r from-gray-900 to-sky-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-3xl font-bold">About Shopitiv</h1>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="space-y-3 text-gray-600">
                <p>Shopitiv was founded in 2017 in Vienna with one goal: make quality tech accessible at fair prices.</p>
