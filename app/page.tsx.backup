...
export default function Home() {
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-br from-gray-900 via-sky-900 to-gray-900 text-white">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-5">
                Premium Tech, <span className="text-sky-400">Best Prices</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/products" className="px-6 py-3 bg-sky-600 hover:bg-sky-500 text-white font-medium rounded-lg">
                  View Products
                </Link>
      ...
      <section className="py-16 md:py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-10">Why Shopitiv?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-5 bg-gray-800 rounded-xl">
                <div className="w-8 h-8 bg-sky-600 rounded-lg flex items-center justify-center mb-3">
      ...
      <section className="py-16 md:py-20 bg-sky-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-sky-200 text-sm mt-4">Or email info@shopitiv.com</p>
        </div>
      </section>
    </div>
  );
